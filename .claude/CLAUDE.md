...
### Code health
Three co-equal signals: code health 5.98/10 avg (Fair), hotspot health 3.47/10 (declining), worst `source/menus/menu_audioplayer.c` at 1.0/10 · maintainability 4.72/10 · performance risk 0 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `source/menus/menu_audioplayer.c` — complex method (Menu_RunNowPlayingLoop) — impact −0.7
