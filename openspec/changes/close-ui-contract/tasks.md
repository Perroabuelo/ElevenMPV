...
- [x] 4.4 Revisar el contador de agotamiento del pool tras sumar la geometría de esta etapa y, si el margen quedó estrecho, ajustar el tamaño del pool en la llamada de inicialización
